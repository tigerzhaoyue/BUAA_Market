          ...
          <tr>
            <td  bgcolor="#555555"><table width="557" border="0" align="center" cellpadding="0" cellspacing="0">
              <form name="form1" method="post" action="savereg.php" onSubmit="return chkinput(this)">
                <tr>
                  <td height="20" bgcolor="#FFFFFF"><div align="center">用户账号：</div></td>
                  <td height="20" bgcolor="#FFFFFF"><div align="left">
                    <input type="text" name="username" size="25" class="inputcss" style="background-color:#e8f4ff " onMouseOver="this.style.backgroundColor='#ffffff'" onMouseOut="this.style.backgroundColor='#e8f4ff'">
                    <span style="color: #FF0000">*</span>&nbsp;
                    <input name="button2" type="button" class="buttoncss" onclick="chknc(form1.username.value)" value="查看用户名是否可用">
                     </div></td>
                  </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td height="20" bgcolor="#FFFFFF"><div align="left">
                    <select name="ts1" class="inputcss">
                      ...
                      <option value="你的生日">您的生日</option>
                      <option value="你在哪里出生">你在哪里出生</option>
                      <option value="你的爱好">你的爱好</option>
                      <option value="你母亲的名字">您母亲的名字</option>
                      <option value="你父亲的名字">您父亲的名字</option>
                      <option value="你最喜欢的花">您最喜欢的花</option>            
                      </select>
  &nbsp;&nbsp;其他:&nbsp;&nbsp;
