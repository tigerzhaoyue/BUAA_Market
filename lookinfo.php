          ...
          <tr>
            <td bgcolor="#666666">
              <table width="530" border="0" align="center" cellpadding="0" cellspacing="1">
                <?php
		     $sql=$conn->query("select * from shangpin where id=".$_GET['id'].""); 
			 $info=$sql->fetch_array(MYSQLI_BOTH);
			 $sellerid=$info['ownerid'];
			 $sqlseller=$conn->query("select * from user where id=".$sellerid.""); 
			 $infoseller=$sqlseller->fetch_array(MYSQLI_BOTH);
		   ?>
                <tr>
                  <td width="89" height="80" rowspan="4" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
                      <?php
			    if($info['image']==""){
				  $imhpath="./upimages/0.jpg";
				}
				else
				  $imgpath=$info['image'];
				{
			  ?>
                      <a href="<?php echo $imgpath;?>" target="_blank"><img src="<?php echo $imgpath;?>" alt="查看大图" width="80" height="80" border="0"></a>
                      <?php
			    }
			  ?>
                  </div></td>
                  <td width="92" height="20" align="left" bgcolor="#FFFFFF"><div align="center">商品名称：</div></td>
                  <td width="134" bgcolor="#FFFFFF"><div align="left">&nbsp;<?php echo $info['name'];?></div></td>
                ...
                <tr>
                  <td height="20" align="left" bgcolor="#FFFFFF"><div align="center">卖家昵称：</div></td>
                  <td width="134" bgcolor="#FFFFFF"><div align="left">&nbsp;<?php echo $infoseller['nc'];?></div></td>
...
&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $info['introduce'];?></div></td>
                </tr>
            </table></td>
          </tr>
        </table>
