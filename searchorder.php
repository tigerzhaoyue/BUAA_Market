...
<table width="766" height="438" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="557" align="center" valign="top" bgcolor="#FFFFFF">      <table width="557" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <?php
	  	$name=$_POST['name'];
	   $sql=$conn->query("select count(*) as total from shangpin where name like '%".$name."%'");
        ...
        <?php
		   ...
		   if ($total<=$pagesize){
			...
			if(!isset($_GET['page'])){
             ...
             $sql1=$conn->query("select * from shangpin where name like '%".$name."%' order by rand() desc limit ".($page-1)*$pagesize.",$pagesize ");
