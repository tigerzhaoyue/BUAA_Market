	...
	function chkinput1(form)
	{
	  ...
	  if(form.price.value=="")
	   ...
	   return(true);
              ...
              <form name="form1" enctype="multipart/form-data" method="post" action="savechangegoods.php" onsubmit="return chkinput1(this)">
                <?php
		   ...
		   $usid=$info['id'];
		   $cargoid=$_GET['id'];
		   $cargosql=$conn->query("SELECT * FROM shangpin WHERE id='$cargoid'");
		   $cargoinfo=$cargosql->fetch_array(MYSQLI_BOTH);
		  
		  ?>
                <tr>
                  <td height="25" bgcolor="#FFFFFF"><div align="center">商品名称：</div><input type="hidden" name="cargoid"  value="<?php echo $cargoinfo['id'];?>"></td>
                  <td height="25" bgcolor="#FFFFFF"><div align="left">
                      <input type="text" name="cargoname" size="25" class="inputcss" value="<?php echo $cargoinfo['name'];?>">
                  </div></td>
                </tr>
                 ...
                 <tr>
                  ...
                  <td height="25" bgcolor="#FFFFFF"><div align="left">
                      <input type="text" name="price" size="25" class="inputcss" value="<?php echo $cargoinfo['price'];?>">
                  </div></td>
                </tr>
		    ...
		    ?>
                ...
                <tr>
                  ...
                  <td height="25" bgcolor="#FFFFFF"><div align="left">
                     <textarea name="jianjie" cols="45" rows="8" class="inputcss" ><?php echo $cargoinfo['introduce'];?></textarea>
        		  </div></td>
                </tr>
                ...
                <tr>
                  <td height="25" bgcolor="#FFFFFF"><div align="center">修改图片：</div></td>
                  <td height="25" bgcolor="#FFFFFF"><div align="left">
