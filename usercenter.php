    ...
    <td width="537" align="center" valign="top" bgcolor="#FFFFFF"><table width="500" height="10" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <table width="550" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <span style="color: #0000FF">丨</span><a href="usercenter.php">修改个人信息</a>&nbsp;
          <span style="color: #0000FF">丨</span><a href="userleaveword.php">用户留言</a>&nbsp;
          <span style="color: #0000FF">丨</span><a href="changeuserpwd.php">修改密码</a>&nbsp;
      ...
      <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
		  ...
		  ?>
                 <tr>
                  <td width="100" height="20" bgcolor="#FFFFFF"><div align="center">用户名：</div>
                   <input type="hidden" name="usnm"  value="<?php echo $_SESSION['username'];?>">
                  </td>
                  <td width="397" bgcolor="#FFFFFF"><div align="left"><?php echo $_SESSION['username'];?></div></td>
                </tr>
                <tr>
                  <td height="20" bgcolor="#FFFFFF"><div align="center">昵称：</div></td>
                  <td height="20" bgcolor="#FFFFFF"><div align="left">
                      <input type="text" name="nc" size="25" class="inputcssnull" value="<?php echo $info['nc'];?>">
                  </div></td>
                </tr>
                <tr>
...
&nbsp;&nbsp;
      ...
      <table width="500" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><div align="center" style="color: #0000FF"><br><br><br>注：蓝色字体为可修改项</div></td>
        </tr>
      </table></td>
  </tr>
</table>
